...
const companies = [
    {
        id: 1,
        name: 'Gontu Softwares Technologies',
    },
    {
        id: 2,
        name: 'Synetal Solutions Pvt. Ltd.',
    },
    {
        id: 3,
        name: 'Cloud 2 Reach Pvt. Ltd.',
    },
];
                        ...
                        <div className=''>
                            {
                                companies.map((item, index) => {
                                    return (
                                        <div>
                                            <button key={index} onClick={() => { setIsSelected(item.id) }} className={`${isSelected === item.id ? 'border-secondary border-l-4 text-secondary ' : 'border-l text-slate500 ml-[2px] '} text-medium py-5 px-4 hover:bg-navy400 hover:text-secondary`}>{item.name}</button>
                                        </div>
                                    )
                                })
                            }
                        ...
                        isSelected === 1 ?
                            <div>
                                <div >
                                    ...
                                    <h6 className='text-slate300 font-medium mt-3 flex items-center'>May 2023 - Current <div className='ml-2 w-3 h-3 bg-secondary rounded-full'></div></h6>
                                </div>
                                <div className='mt-5'>
                            ...
                            isSelected === 2 ?
                                <div>
                                    <div >
                                        ...
                                        <h6 className='text-slate300 font-medium mt-3'>Jan 2020 - May 2023</h6>
                                    </div>
                                    <div className='mt-5'>
                                        <ul className='list-disc text-slate500 pl-5 text-lg'>
                                            <li>
                                ...
                                isSelected === 3 ?
                                    <div>
                                        <div >
                                            <h3 className='text-2xl font-semibold text-slate300'>Senior Frontend Developer <span className='text-secondary'> @ Gontu Softwares Technologies</span></h3>
                                            <h6 className='text-slate300 font-medium mt-3'>May 2023 - Current</h6>
                                        </div>
                                        <div className='mt-5'>
                                            <ul className='list-disc text-slate500 pl-5 text-lg'>
                                                <li className='py-2'>
